...
// ============= PÁGINA =============
class AgregarProductoFacturaMobile extends ConsumerStatefulWidget {
  final List<ItemFacturaModel>? itemsIniciales;

  const AgregarProductoFacturaMobile({super.key, this.itemsIniciales});

  @override
  ConsumerState<AgregarProductoFacturaMobile> createState() => _AgregarProductoFacturaPageState();
}

class _AgregarProductoFacturaPageState extends ConsumerState<AgregarProductoFacturaMobile> {
