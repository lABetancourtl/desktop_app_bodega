...
import 'desktop/crear_factura_clientes_desktop.dart';
import 'mobile/crear_factura_clientes_mobile.dart';


class CrearFacturaPage extends StatelessWidget {
  const CrearFacturaPage({super.key});

  @override
  Widget build(BuildContext context) {
    if (PlatformService.isDesktop) {
      return const CrearFacturaDesktop();
    } else {
      return const CrearFacturaMobile();
    }
  }
}