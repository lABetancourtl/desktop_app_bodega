...
class EditarClienteMobile extends StatefulWidget {
  final ClienteModel cliente;

  const EditarClienteMobile({super.key, required this.cliente});

  @override
  State<EditarClienteMobile> createState() => _EditarClienteMobileState();
}

class _EditarClienteMobileState extends State<EditarClienteMobile> {
