...
// ============= PÁGINA PRINCIPAL =============
class ProductosMobile extends ConsumerStatefulWidget {
  const ProductosMobile({super.key});

  @override
  ConsumerState<ProductosMobile> createState() => _ProductosPageState();
}

class _ProductosPageState extends ConsumerState<ProductosMobile> with TickerProviderStateMixin {
